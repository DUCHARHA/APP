...
export function BannerSlider() {
  ...
  if (visibleBanners.length === 0) {
    ...
    return (
      <section className="text-white p-6 relative overflow-hidden h-[200px] flex items-center mx-4 mt-4 mb-8 rounded-lg bg-[#5B21B6]">
  ...
  return (
    <section 
      className="text-white p-6 relative overflow-hidden h-[200px] flex items-center mx-4 mt-4 mb-8 rounded-lg transition-all duration-700 ease-in-out"
      style={{
