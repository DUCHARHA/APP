...
export default function Help() {
  const faqItems = [
    {
      ...
      answer: "Мы доставляем заказы в течение 15 минут с момента оформления. В часы пик время доставки может увеличиться до 20 минут.",
    },
    {
    ...
    },
    {
      ...
      answer: "Мы принимаем оплату картой (Visa, MasterCard, МИР) и наличными курьеру при получении заказа. Также можем принять онлайн оплату переводом, если вы заказываете другому человеку. Для этого напишите в поддержку.",
    },
    {
  ...
  return (
    <main className="pb-20">
      {/* Header */}
      <header className="bg-white dark:bg-card shadow-sm sticky top-0 z-40 pt-[env(safe-area-inset-top,0)]">
